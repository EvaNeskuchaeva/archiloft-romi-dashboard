...
const seedDeals = [
  ["2024-05-01", "Instagram / FB", "Свадьбы", "Анна Смирнова", "event", 42, 62000, 360000, 138000],
  ["2024-05-03", "Telegram", "Корпоративы", "Иван Петров", "booked", 28, 41000, 270000, 99000],
  ["2024-05-05", "Яндекс.Директ", "Дни рождения", "Мария Кузнецова", "event", 31, 52000, 220000, 85000],
  ["2024-05-08", "Google Ads", "Лекции / Мастер-классы", "Алексей Власов", "lead", 22, 33000, 88000, 39000],
  ["2024-05-09", "2GIS", "Фото / Видео съемки", "Анна Смирнова", "event", 18, 21000, 120000, 46000],
  ["2024-05-10", "Avito", "Презентации", "Иван Петров", "booked", 15, 16000, 90000, 32000],
  ["2024-05-11", "Event-агентства", "Конференции", "Мария Кузнецова", "event", 25, 34000, 180000, 70000],
  ["2024-05-12", "Сарафанное радио", "Бизнес-завтраки", "Алексей Власов", "event", 12, 4000, 65000, 24000],
  ["2024-05-16", "Instagram / FB", "Свадьбы", "Анна Смирнова", "booked", 36, 54000, 310000, 121000],
  ["2024-05-17", "Telegram", "Корпоративы", "Иван Петров", "event", 24, 30000, 210000, 77000],
  ["2024-05-19", "Яндекс.Директ", "Дни рождения", "Мария Кузнецова", "event", 26, 39000, 170000, 63000],
  ["2024-05-20", "Google Ads", "Лекции / Мастер-классы", "Алексей Власов", "hold", 14, 21000, 56000, 23000],
  ["2024-05-21", "2GIS", "Фото / Видео съемки", "Анна Смирнова", "event", 11, 14000, 82000, 31000],
  ["2024-05-22", "Avito", "Презентации", "Иван Петров", "lead", 10, 12000, 42000, 16000],
  ["2024-05-24", "Event-агентства", "Конференции", "Мария Кузнецова", "booked", 19, 27000, 130000, 51000],
  ["2024-05-26", "Сарафанное радио", "Бизнес-завтраки", "Алексей Власов", "event", 8, 2000, 50000, 19000],
  ["2024-04-04", "Instagram / FB", "Свадьбы", "Анна Смирнова", "event", 38, 58000, 315000, 119000],
  ["2024-04-13", "Telegram", "Корпоративы", "Иван Петров", "event", 21, 29000, 195000, 72000],
  ["2024-04-18", "Яндекс.Директ", "Дни рождения", "Мария Кузнецова", "event", 23, 36000, 155000, 59000],
  ["2024-03-08", "Instagram / FB", "Свадьбы", "Анна Смирнова", "event", 33, 51000, 260000, 104000],
  ["2024-03-15", "Google Ads", "Корпоративы", "Иван Петров", "event", 18, 26000, 145000, 58000],
  ["2024-02-07", "Яндекс.Директ", "Дни рождения", "Мария Кузнецова", "event", 21, 33000, 120000, 51000],
  ["2024-01-12", "Telegram", "Корпоративы", "Иван Петров", "event", 17, 24000, 112000, 42000],
  ["2023-12-14", "Instagram / FB", "Свадьбы", "Анна Смирнова", "event", 19, 31000, 130000, 48000],
  ["2023-11-09", "Сарафанное радио", "Бизнес-завтраки", "Алексей Власов", "event", 9, 3000, 32000, 12000]
...
const managers = ["Анна Смирнова", "Иван Петров", "Мария Кузнецова", "Алексей Власов"];
const statuses = [
  ["lead", "Лид"],
  ["hold", "Просмотр"],
  ["booked", "Бронь"],
